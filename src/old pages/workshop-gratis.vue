<template>
  <div class="signup content">
    ...
    <p>
      Kom och dansa med oss den <strong>13 september kl. 10:00–12:15</strong> på
      <strong>Skylten</strong> (Södra Oskarsgatan 3)! Vi bjuder på två pass –
      ett i <strong>burlesque</strong> och ett i
      <strong>feminine vibe</strong> – där du får prova på våra stilar, ha kul
      och uttrycka dig fritt.
    </p>

    <p>
      Det är helt gratis att delta – allt vi ber om är att vi får fota och filma
      under passen och använda materialet i våra sociala kanaler.
      <strong>Inga förkunskaper krävs.</strong>
    </p>

    <p>
      Anmäl dig i formuläret nedan (eller via DM på Instagram) och ange om du
      vill vara med på <strong>burlesque, feminine vibe</strong> eller
      <strong>båda passen</strong>.
    </p>
    <form class="form" ref="form" @submit="onSubmit">
      ...
      <fieldset>
        ...
        <div class="form__error" v-if="!!sessionsError">
          {{ sessionsError }}
        </div>
      </fieldset>
...
const { value: sessions, errorMessage: sessionsError } = useField<string>(
  "sessions",
  "required"
);
