<template>
  <div class="footer">
    <a href="https://www.instagram.com/femmefusionofficial/" target="_blank" class="footer__icon">
    ...
    <a href="https://www.facebook.com/femmefusionofficial" target="_blank" class="footer__icon">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0,0,256,256"
        width="256px" height="256px">
        <g transform="">
          <g fill-opacity="0" fill="#be0e0e" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt"
            stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none"
            font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
    ...
    <a href="mailto:info@femmefusion.se" class="footer__icon footer__icon--mail">
